...
const targetDir = path.resolve(__dirname, '..', 'Phan_Mem_Lich_Bao_Giang_Lop_5_V9');
const targetZip = path.resolve(__dirname, '..', 'Phan_Mem_Lich_Bao_Giang_Lop_5_V9.zip');
...
if (fs.existsSync(targetDir)) {
    console.log("Đang xóa thư mục V9 cũ...");
    fs.rmSync(targetDir, { recursive: true, force: true });
}
if (fs.existsSync(targetZip)) {
    console.log("Đang xóa file zip V9 cũ...");
...
const itemsToCopy = [
    'index.html',
    'README.md',
    'Huong_Dan_Su_Dung_V9.txt',
    'Huong_Dan_Chi_Tiet_V9.txt',
