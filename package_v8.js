...
const targetDir = path.resolve(__dirname, '..', 'Phan_Mem_Lich_Bao_Giang_Lop_5_V8');
const targetZip = path.resolve(__dirname, '..', 'Phan_Mem_Lich_Bao_Giang_Lop_5_V8.zip');
...
if (fs.existsSync(targetDir)) {
    console.log("Đang xóa thư mục V8 cũ...");
    fs.rmSync(targetDir, { recursive: true, force: true });
}
if (fs.existsSync(targetZip)) {
    console.log("Đang xóa file zip V8 cũ...");
