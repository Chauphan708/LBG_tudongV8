...
assert.ok(htmlContent.includes('Bản V7') || htmlContent.includes('Bản V8') || htmlContent.includes('Bản V9'), "index.html title chưa cập nhật Bản V7, V8 hoặc V9");
assert.ok(htmlContent.includes('BẢN V7') || htmlContent.includes('BẢN V8') || htmlContent.includes('BẢN V9'), "index.html header badge chưa cập nhật BẢN V7, V8 hoặc V9");
assert.ok(htmlContent.includes('Hướng Dẫn V7') || htmlContent.includes('Hướng Dẫn V8') || htmlContent.includes('Hướng Dẫn V9') || htmlContent.includes('Hướng Dẫn'), "index.html quick button chưa có Hướng Dẫn");
